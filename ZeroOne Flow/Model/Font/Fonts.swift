...
struct Fonts: Equatable, Identifiable {
    ...
    init(size: CGFloat = 0, design: FontDesign = .monospaced,
         weight: FontWeight = .regular, min: CGFloat = 10, max: CGFloat = 50) {
        self.size = size
        self.design = design
        self.weight = weight
    ...
    mutating func set(size: CGFloat? = nil, design: FontDesign, weight: FontWeight,
                      min: CGFloat? = nil, max: CGFloat? = nil) {
    ...
    mutating func set(size: CGFloat? = nil, design: Int, weight: Int,
                      min: CGFloat? = nil, max: CGFloat? = nil) {
        if let size = size { self.size = size }
